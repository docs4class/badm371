...
Actually, this single data frame contains 13 datasets, designed to show us why data visualisation is important and how summary statistics alone can be misleading.  The different datasets are marked by the `dataset` variable.
...
```{marginfigure}
Feel free to work with a frind (or an enemy?), but please make sure YOU now know how to this excercise and understand it 
```
